...
export default function CategoriesPage() {
  ...
  const rawMaterialCategories = [
    ...
    {
      name: "Candle Jars & Containers",
      categoryParam: "Candle Jars & Containers",
      count: "71 Items",
      desc: "Amber glass jars, metal tins, frosted candle vessels, and tight-seal closures.",
      icon: Package,
      color: "bg-orange-50 text-orange-600 border-orange-100",
    },
    {
      name: "Skincare & Body Bases",
      categoryParam: "Skincare & Body Bases",
      count: "26 Formulations",
      desc: "Ready-to-customize body butter bases, shower gel bases, lotion & cream formulations.",
      icon: FlaskConical,
      color: "bg-cyan-50 text-cyan-600 border-cyan-100",
    },
    {
      name: "Micas & Pigments",
      categoryParam: "Micas & Pigments",
      count: "24 Colors",
      desc: "Pearlescent cosmetic mica powders, resin pigments, and wax dyes.",
      icon: Palette,
      color: "bg-pink-50 text-pink-600 border-pink-100",
    },
    {
      name: "Hydrosols & Floral Waters",
      categoryParam: "Hydrosols & Floral Waters",
      count: "22 Botanicals",
      desc: "Steam-distilled floral and herbal waters — lavender, rose, sandalwood, neem & more.",
      icon: Droplets,
      color: "bg-sky-50 text-sky-600 border-sky-100",
    },
    {
      name: "Artisan Soap Bases",
      categoryParam: "Artisan Soap Bases",
      count: "21 Bases",
      desc: "Goat milk, shea butter, aloe vera, charcoal, and transparent melt & pour soap bases.",
      icon: Sparkles,
      color: "bg-emerald-50 text-emerald-700 border-emerald-100",
    },
    {
      name: "Candle Waxes & Additives",
      categoryParam: "Candle Waxes & Additives",
      count: "9 Waxes",
      desc: "Natural 464 soy wax flakes, beeswax blocks, paraffin slabs, and stearic acid.",
      icon: Flame,
      color: "bg-amber-50 text-amber-700 border-amber-100",
    },
    {
      name: "Wick Systems & Hardware",
      categoryParam: "Wick Systems & Hardware",
      count: "8 Systems",
      desc: "Braided cotton wicks, cross wooden wicks, sustainers, and wick centering tools.",
      icon: Wrench,
