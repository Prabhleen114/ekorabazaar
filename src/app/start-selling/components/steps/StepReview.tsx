...
const Section = ({
  title, step, children, setCurrentStep
}: { title: string; step: number; children: React.ReactNode, setCurrentStep: (s: number) => void }) => (
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-5">
        <Section title="1. Personal Information" step={1} setCurrentStep={setCurrentStep}>
        ...
        <Section title="2. Business Information" step={2} setCurrentStep={setCurrentStep}>
        ...
        <Section title="3. Business Address" step={3} setCurrentStep={setCurrentStep}>
        ...
        <Section title="4. GST Details" step={4} setCurrentStep={setCurrentStep}>
        ...
        <Section title="5. Bank Details" step={5} setCurrentStep={setCurrentStep}>
        ...
        <Section title="6. Identity Documents" step={6} setCurrentStep={setCurrentStep}>
        ...
        <Section title="7. Catalogue Details" step={7} setCurrentStep={setCurrentStep}>
