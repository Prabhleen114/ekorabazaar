...
export const DISCIPLINE_HUBS: DisciplineConfig[] = [
  ...
  {
    id: "perfumery-attar",
    name: "The Perfumery & Attar Studio",
    shortName: "Perfumery & Attar",
    tagline: "Roll-On Vials, Attar Bottles, Atomizers & Fine Aromas",
    icon: "✨",
    description: "Luxury electroplated glass bottles, fine mist spray atomizers, roll-ons, and concentrated pure attar & perfume oils.",
    accentColor: "#b45309",
    badgeBg: "bg-amber-50",
  ...
  {
    id: "culinary-chocolatier",
    name: "The Chocolate & Confectionery Studio",
    shortName: "Chocolatier Studio",
    tagline: "Food-Grade Moulds, Flavours, Fondants & Textures",
    icon: "🍫",
    description: "Polycarbonate and platinum silicone chocolate moulds, cake fondant textures, and oil-soluble food-grade flavourings.",
    accentColor: "#78350f",
  ...
  {
    id: "skincare-apothecary",
    name: "The Haircare & Cosmetic Apothecary",
    shortName: "Cosmetic Apothecary",
    tagline: "Sulfate-Free Bases, Carrier Oils, Hydrosols & Jars",
    icon: "🌿",
    description: "Clean beauty formulation raw materials, cosmetic butters, botanical waters, preservatives, and cosmetic containers.",
    accentColor: "#047857",
    badgeBg: "bg-teal-50",
  ...
  {
    id: "home-fragrance",
    name: "The Diffuser & Home Fragrance Studio",
    shortName: "Diffuser Studio",
    tagline: "Reed Glassware, Fibre Reeds, Car Diffusers & Scents",
    icon: "🌸",
    description: "Heavy-base diffuser bottles, premium porous reed sticks, car hanging diffusers, and concentrated room aroma solutions.",
    accentColor: "#db2777",
    badgeBg: "bg-rose-50",
